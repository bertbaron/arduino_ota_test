...
#
# A simple filter was added limit the size by only including required certificates
...
def include(name):
    return name.startswith("DigiCert")
...
print(f"Ignored {ignored} certificates not matching the filter")
